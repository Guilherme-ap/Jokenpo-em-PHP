<!-- Este arquivo é para caso o usuario tenha escolhido o nivel de jogo dificil ao qual ele ira jogar contra um bot que joga com bot que ira empatar ou ganhar dele -->
<!-- 1 = Tesoura
2 = Papel
3 = Pedra -->
<!DOCTYPE html>
...
<body>
    ...
    <a href="../login_cadastro/bem_vindo.php">Voltar</a>
</fieldset>
</form>
<?php
if(isset($_POST['op'])){
